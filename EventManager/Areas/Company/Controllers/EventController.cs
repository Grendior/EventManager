...
namespace EventManager.Areas.Company.Controllers
{
    [Area(SD.Role_Company)]
    ...
    public class EventController : Controller
    {
        ...
        public EventController(IUnitOfWork unitOfWork,UserManager<IdentityUser> userManager, IWebHostEnvironment webHostEnvironment)
        {
        ...
        public IActionResult Index()
        {
            ...
            var objEventList = _unitOfWork.Event.GetAllFiltered(x => x.CreatorId == userId).ToList();
